...
<html lang="en">
<head>
<title>Đặt phòng khách sạn trực tuyến</title>
<meta charset="utf-8">
...
<body>
  ...
  if(currenttime < 12){
      document.write('<h3 class="text-white">Chào buổi sáng và chào mừng bạn đến!</h3>');
  }else if(currenttime == 12){
      document.write('<h3 class="text-white">Chúc một ngày tốt lành và chào mừng bạn đến!</h3>');
  }else if(currenttime > 12 && currenttime <= 15){
      document.write('<h3 class="text-white">Chào buổi chiều và chào mừng bạn đến!</h3>');
  }else{
      document.write('<h3 class="text-white">Chào buổi tối và chào mừng bạn đến!</h3>');
  }
     </script>
...
<h1 class="mb-4">Khách sạn HuyPeos</h1>
<p><a href="auth/signup.php" class="btn btn-primary p-4 py-3">Đăng ký </a> <a href="auth/login.php" class="btn btn-white btn-outline-white p-4 py-3">Đăng nhập </a></p>
</div>
</div>
</div>
</section>
