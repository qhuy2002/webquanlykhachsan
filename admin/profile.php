            ...
            <div id="content">
               ...
               <!-- Begin Page Content -->
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h3 class="h3 mb-5 font-weight-bold text-uppercase text-gray-800">Quang-Huy Quản lý dữ liệu quản trị khách sạn</h3>
                        ...
                        <div class="col-xl-10 col-lg-10">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-uppercase text-success">Hồ sơ quản trị viên</h6>
                                </div>
                                <!-- Card Body -->
                                <div class="card-body">
                                    <?php
