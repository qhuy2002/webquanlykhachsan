...
<div class="col-lg-10 text-center">
    <p class="breadcrumbs"><span class="me-2"><a href="../default/home.php">Trang Chủ <i class="fa fa-chevron-right"></i></a></span> <span>Tài Khoản Của Tôi <i class="fa fa-chevron-right"></i></span> <span> Hồ Sơ</span></p>
...
<div class="icon"><span class="fa fa-user"></span></div>
    <div class="text">
<h1 class="text-muted">Hồ Sơ Người Dùng</h1>
</div>
        </div>
    </div>
    </div>
...
<div class="col-lg-8 justify-content-center">
    ...
    <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
        ...
        <?php endwhile; ?>
        <button type="submit" name="update" class="btn btn-primary p-4 py-3 my-4" style="width:50%; margin-left:25%">CẬP NHẬT</button>
        </form>
    </div>
