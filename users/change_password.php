...
<div class="col-lg-10 text-center">
    <p class="breadcrumbs"><span class="me-2"><a href="../default/home.php">Trang Chủ <i class="fa fa-chevron-right"></i></a></span> <span>Tài Khoản Của Tôi <i class="fa fa-chevron-right"></i></span> <span>Thay Đổi Mật Khẩu</span></p>
<h1 class="mb-4">Thay Đổi Mật Khẩu Của Tôi</h1>
</div>
</div>
</div>
</section>
...
<div class="icon"><span class="fa fa-key"></span></div>
    <div class="text">
<h1 class="text-muted">Thay Đổi Mật Khẩu</h1>
</div>
        </div>
    </div>
    </div>
...
<div class="col-lg-8 justify-content-center">
  ...
  <?php
    ...
    <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
        ...
        <small id="passwordHelp" class="text-muted text-primary mb-3">Phải có ít nhất 8 ký tự.</small><br>
        <br/>
        ...
        <?php endwhile; ?>
        <button type="submit" name="resetPassword" class="btn btn-block btn-primary p-4 py-3 mb-4" style="width:100%">THAY ĐỔI MẬT KHẨU</button>
        </form>
    </div>
