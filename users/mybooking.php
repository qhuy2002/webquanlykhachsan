...
<div class="col-lg-10 text-center">
    <p class="breadcrumbs"><span class="me-2"><a href="../default/home.php">Trang Chủ <i class="fa fa-chevron-right"></i></a></span> <span>Tài Khoản Của Tôi <i class="fa fa-chevron-right"></i></span> <span> Đặt Phòng Của Tôi</span></p>
...
<div class="col-lg-12 justify-content-center">
    ...
    <thead class="bg-dark text-white">
        ...
        <tr>
            ...
            <td><a href="../users/mybooking-dtl.php?id=<?php echo $row['id']; ?>" class="btn btn-primary btn-block">Xem</a></td>
            </tr>
            <?php endwhile; ?>
        </tbody>
    </table>
