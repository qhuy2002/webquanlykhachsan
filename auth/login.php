...
<div class="col-lg-6 text-white">
    ...
    <li class="nav-item"><a class="nav-link" href="../index.php">Trang Chủ</a></li>
        <li class="nav-item"><a class="nav-link " href="../auth/signup.php">Đăng ký</a></li>
        <li class="nav-item"><a class="nav-link active" href="../auth/login.php">Đăng nhập</a></li>
    </ul>
<!---Login form ----->
    <div id="form-holder">
    ...
    <form method="post" action="../processors/handle-login.php">
        ...
        <input type="password" class="form-control mb-4" id="password" placeholder="Nhập mật khẩu" name="password" required/>    <div class="input-group-append">
        ...
        <button type="submit" name="login" class="btn btn-block btn-primary p-4 py-3 mb-4" style="width:100%">Đăng nhập <span class="fa fa-sign-in-alt"></span></button>
        <a href="../auth/forgot.php">Quên mật khẩu?</a>
        </form>
    </div>
    <!--- End of login form---->
    <style>
