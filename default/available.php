...
<span class="subheading">Tận hưởng thời gian tuyệt vời của bạn với một trải nghiệm xa xỉ tuyệt vời!</span>
<h1 class="mb-4">Phòng/phòng có sẵn</h1>
</div>
</div>
</div>
</section>
...
<span class="subheading">Phòng và hội trường của chúng tôi</span>
<h2 class="mb-4">Phòng/phòng có sẵn</h2>
</div>
</div>
<div class="row justify-content-center">
    <?php
